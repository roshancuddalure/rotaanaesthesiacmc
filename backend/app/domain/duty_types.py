...
DUTY_TYPES: tuple[DutyType, ...] = (
    ...
    duty_type("RC_3RD_CALL_A", "RC 3rd Call A", "rc"),
    duty_type("RC_3RD_CALL_B", "RC 3rd Call B", "rc"),
    duty_type("MAIN_PAC_PG", "Main PAC PG (3rd Call C)", "pac"),
    duty_type("MAIN_PAC_SR", "Main PAC SR (Legacy A/B)", "pac"),
    duty_type("MAIN_PAC_SR_A", "Main PAC SR (3rd Call A)", "pac"),
    duty_type("MAIN_PAC_SR_B", "Main PAC SR (3rd Call B)", "pac"),
    duty_type("MAIN_PAC_3RD", "Main PAC 3rd Call", "pac"),
    duty_type("MAIN_PAC_SENIOR", "Main PAC Senior (4th Call)", "pac"),
    duty_type("RC_PAC_SR", "RC PAC SR (Legacy A/B)", "pac"),
    duty_type("RC_PAC_SR_A", "RC PAC SR (3rd Call A)", "pac"),
    duty_type("RC_PAC_SR_B", "RC PAC SR (3rd Call B)", "pac"),
    duty_type("RC_PAC_3RD", "RC PAC 3rd Call", "pac"),
    duty_type("RC_PAC_SENIOR", "RC PAC Senior (4th Call)", "pac"),
